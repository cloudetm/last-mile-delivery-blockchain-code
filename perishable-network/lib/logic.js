 ...
 * @transaction
 */
function payOut(shipmentReceived) {  // eslint-disable-line no-unused-vars
...
.then (function (ParticipantRegistry) {
        return ParticipantRegistry.update(contract.grower);
    }).then (function () {
        return getParticipantRegistry('org.acme.shipping.perishable.Importer');
        })
        .then(function (ParticipantRegistry) {
        return ParticipantRegistry.update(contract.importer);
        }).then (function () {
 ...
 * @transaction
 */
function temperatureReading(temperatureReading) {  // eslint-disable-line no-unused-vars
...
function setupDemo(setupDemo) {  // eslint-disable-line no-unused-vars
    ...
    .then (function (ParticipantRegistry) {
            return ParticipantRegistry.addAll([grower]);
        }).then (function () {
            return getParticipantRegistry(NS + '.Importer');
            })
            .then(function (ParticipantRegistry) {
            return ParticipantRegistry.addAll([importer]);
        }).then (function () {
            ...
            .then(function (AssetRegistry) {
            return AssetRegistry.addAll([contract]);
        }).then (function () {
            return getAssetRegistry(NS + '.Shipment');
            })
            .then(function (AssetRegistry) {
            return AssetRegistry.addAll([shipment]);
        })
}